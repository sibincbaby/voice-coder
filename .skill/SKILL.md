---
name: voice-coder
description: Transcribe a local audio file (wav/mp3/ogg/flac/m4a/aac/webm) to text using `voice-coder analyze`. Use when the user has an audio file and needs its spoken content as text or JSON. Outputs { file, profile, text }.
---
